                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="{{asset($product->image)}}" height="745" width="635" alt="product image" />
                                            </figure>
                                        </div>
                                        <!-- THUMBNAILS -->
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            @foreach($product->otherImages  as $otherImage)
                                            <div><img src="{{asset($otherImage->image)}}" height="115" width="115" alt="product image"></div>
                                            @endforeach
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand"> {{ $product->selling_price. ' TK.' }}</span></ins>
                                                <ins><span class="old-price font-md ml-15">{{ $product->regular_price. ' TK.' }}</span></ins>
                                        ...
                                        <div class="detail-extralink">
                                            <form action="{{ route('cart.add', ['id' => $product->id]) }}" method="POST">
                                                @csrf
                                                <input type="number" class="qty-button" name="quantity" min="1" value="1" />
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            <li class="mb-5">Tags: <a href="#" rel="tag">{{ $product->subCategory->name }}</a> </li>
                                            <li>Availability:<span class="in-stock text-success ml-5">{{ $product->stoke_amount }} Items In Stock</span></li>
                                        </ul>
                                    </div>
                                    <!-- Detail Info -->
                                </div>
