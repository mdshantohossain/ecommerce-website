    ...
    <main class="main">
        ...
        <section class="pt-150 pb-150">
            <div class="container">
                <div class="row">
                    <div>
                        <h5 class="text-danger text-center mb-3">{{ session('wrongPassword') }}</h5>
                        <h5 class="text-success text-center mb-3">{{ session('message') }}</h5>
                    </div>
                                    ...
                                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="mb-0">Hello {{ $customer->name }}! </h5>
                                            </div>
                                            <div class="card-body">
                                                <p>From your account dashboard. you can easily check &amp; view your recent orders, manage your  and  your password and account details.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="account-detail" role="tabpanel" aria-labelledby="account-detail-tab">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="{{ route('customer.profile.update') }}" method="POST" name="enq">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            <label>Full Name <span class="required">*</span></label>
                                                            <input class="form-control square" value="{{ $customer->name }}" name="name" type="text" />
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label>Email Address <span class="required">*</span></label>
                                                            <input class="form-control square" value="{{ $customer->email }}" name="email" type="email" />
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label>Phone Number <span class="required">*</span></label>
                                                            <input class="form-control square" value="{{ $customer->phone }}" name="phone" type="text" />
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label>Current Password <span class="required">*</span></label>
                                                            <input class="form-control square" name="current_password" type="password">
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="card mb-3 mb-lg-0">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <textarea name="address">{{ $customer->adderss }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="card">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <textarea class="delivery_address">{{ $customer->delivery_address }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <button type="submit" class="btn btn-fill-out submit">Update</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
