                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#">
                                                <img class="default-img" src="{{asset($product->image)}}" height="275" width="275" alt="">
                                                <img class="hover-img" src="{{asset($product->image)}}" height="275" width="275" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up quickView" data-bs-toggle="modal" data-id="{{ $product->id }}" data-bs-target="#quickViewModal"><i class="fi-rs-eye"></i></a>
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up" href="{{ Session::has('customer_id') ?  route('wishlist.create', ['id' => $product->id]) : '#loginModal' }}" {{ Session::has('customer_id') ? '' : 'data-bs-toggle=modal' }}><i class="fi-rs-heart"></i></a>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('detail', ['id' => $product->id]) }}">{{ substr($product->name, 0, 24). '...' }}</a></h2>
