...
@section('body')
    ...
    <div class="row">
        ...
        <div class="col-xl-6 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h4 class="text-center mb-4">Category update Form</h4>
                    ...
                    <form action="{{ route('category.update', ['id' => $category->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea name="description" class="form-control" placeholder="Enter you Category Category" rows="5">{{ $category->description }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{ asset($category->image) }}" width="220" height="150" alt="">
                            </div>
                        </div>
