                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="#" class="has-arrow waves-effect">
                            ...
                            <span key="t-tables">Sub Category Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('sub-category.add') }}" key="t-basic-tables">Add Sub Category</a></li>
                            <li><a href="{{ route('sub-category.manage') }}" key="t-data-tables">Manage Sub Category</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#" class="has-arrow waves-effect">
                            ...
                            <span key="t-ui-elements">Unit Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('unit.add') }}" key="t-alerts">Add Unit</a></li>
                            <li><a href="{{ route('unit.manage') }}" key="t-buttons">Manage Unit</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#" class="has-arrow waves-effect">
                            ...
                            <span key="t-tasks">Brand Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('brand.add') }}" key="t-task-list">Add Brand</a></li>
                            <li><a href="{{ route('brand.manage') }}" key="t-kanban-board">Manage Brand</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#" class="has-arrow waves-effect">
                            ...
                            <span key="t-blog">Product Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('product.add') }}" key="t-blog-list">Add Product</a></li>
                            <li><a href="{{ route('product.manage') }}" key="t-blog-grid">Manage Product</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#" class="has-arrow waves-effect">
                            ...
                            <span key="t-charts">Order Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('order.manage') }}" key="t-apex-charts">Manage Order </a></li>
                            <li><a href="{{ route('order.complete') }}" key="t-e-charts">Complete Order</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#" class="has-arrow waves-effect">
                            ...
                            <span key="t-projects">Company Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="#" key="t-p-grid">Projects Grid</a></li>
                            <li><a href="#" key="t-p-list">Projects List</a></li>
                        </ul>
                    </li>
